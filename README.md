# Prática Efeito Monga - Códigos Arduino

Bem-vindo ao repositório do **Efeito Monga**, onde você encontrará todos os códigos Arduino utilizados para automatizar a iluminação e reproduzir a ilusão óptica do *Fantasma de Pepper*.  
...
![Circuito Mostrando as Ligações](pot.png)
...
Diagrama do Circuito mostrando as Ligações:
![Circuito Mostrando as Ligações](bot.png)
